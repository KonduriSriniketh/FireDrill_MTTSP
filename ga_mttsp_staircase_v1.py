...
def main():
    ...
    for i, txt in enumerate(n):
        ...
        plt.plot([problem.point_profile[problem.final_output_sequence[i],0],problem.final_robot_intersection_pt[i,0]],
                 [problem.point_profile[problem.final_output_sequence[i],1],problem.final_robot_intersection_pt[i,1]],
                 color = 'green',
                 linestyle='dashed')
        ...
        plt.annotate(problem.final_output_sequence[i],
